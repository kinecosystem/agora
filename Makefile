...
.PHONY: build build-agora build-history-collector build-migrator
build: build-agora build-history-collector build-migrator
build-agora:
...
.PHONY: images-only agora-image history-collector-image migrator-image
images-only: agora-image history-collector-image migrator-image
agora-image:
